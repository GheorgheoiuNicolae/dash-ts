/* Generated by svg icon generator - edit only .nunjucks template if needed */
...
export default class Icon extends React.Component<IconProps, {}> {
  ...
  getIcon(kind: string) {
    const { height, color, onClick, size, width } = this.props;

    // tslint:disable
    switch (kind) {
      default: return null;
      case ('aggregates'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 47 32"><title>aggregates</title><path stroke="var(--color1,gray)" d="M13.364 25.618c-1.693 1.962-2.101 3.776-3.881 3.881-1.219.071-3.274-.293-3.437-1.509-.096-.709-.594-1.56-.444-2.372.312-1.688 1.975-3.922 3.881-3.881 2.715.059 4.963 2.626 3.881 3.881zM42.02 27c-1.144 1.326-1.421 2.554-2.625 2.625-.824.047-2.213-.197-2.324-1.021-.065-.479-.403-1.054-.3-1.604.209-1.141 1.335-2.653 2.624-2.625 1.837.041 3.357 1.776 2.625 2.625zM26.748 29.51c-1.104.256-3.054-.247-3.209-1.284-.088-.603-.266-1.329-.413-2.019-.232-1.097 1.319-1.768 1.571-2.325.304-.666 1.312-.834 2.051-.978 2.974-1.04 2.482 6.031 0 6.606z"/><path stroke="var(--color1,gray)" strokeWidth="1.882" d="M18.706 28.927c-2.376-2.053-4.576-2.546-4.703-4.704-.087-1.476.353-3.966 1.828-4.165.859-.116 1.891-.721 2.875-.538 2.047.376 4.754 2.393 4.704 4.703-.074 3.291-3.184 6.016-4.704 4.704zM29.32 27.694c-.368-3.374-1.766-5.424 0-7.166 1.135-1.119 8.965 5.446 7.166 7.166-2.56 2.451-6.932 2.151-7.166 0z"/><path fill="var(--color1,gray)" d="M36.825 29.264c-.463.24-1.01.19-1.596 0-1.854.425-3.737.407-5.644 0a4.38 4.38 0 0 0-1.343 0c-1.382.428-2.807.404-4.266 0-.763-.107-1.699-.081-2.703 0-.865.362-1.906.288-3.037 0-2.285-.257-4.621-.247-6.999 0-1.6.341-3.301.307-5.076 0-2.19-.135-4.265-.157-6.162 0v1.244h45.969v-1.244c-1.338-.379-3.028-.349-4.988 0-1.451.447-2.85.529-4.156 0z"/><path stroke="var(--color1,gray)" strokeWidth="1.882" d="M14.883 19.343c-.515 1.269-1.396 3.365-2.466 3.125-.847-.188-1.574-1.074-2.156-1.601-.363-.332-.515-1.009-.31-1.524.493-1.241 1.541-2.615 2.466-3.125 1.709-.944 3.359 1.599 2.466 3.125zM28.799 19.485c-1.056 3.343-5.388 5.306-6.01 2.374-.162-.804-.834-1.465-.834-2.374 0-.975.466-1.779.953-2.512.466-.699 1.243-.496 2.469-1.115 2.893-1.46 4.534.103 3.422 3.626zM40.298 20.61c1.665 1.468-1.553 4.387-3.385 4.019-1.634-.328-4.591-2.472-3.385-4.019.769-.985 2.454-2.79 3.385-4.019.656-.865 3.26.324 2.644 1.376-.515.876-.184 1.826.741 2.643z"/><path stroke="var(--color1,gray)" strokeWidth="1.882" d="M36.13 15.13c-1.172 2.787-2.14 5.425-3.778 5.5-1.215.054-2.296-.835-2.987-2.131-.496-.931-.063-2.329-.793-3.369-1.643-2.346-1.572-4.271 1.957-4.819.684-.106 1.16-.681 1.822-.681 1.651 0 1.674 2.554 3.568 3.688.943.563.538 1.035.21 1.812zM22.866 15.033c-.994.888-1.551 2.151-1.432 3.344.251 2.493-1.381 1.56-2.779 1.109-1.337-.163-3.232.179-3.571-2.087-.116-.788-.963-1.559-.643-2.366.472-1.184 1.331-2.259 1.184-3.096-.194-1.118 2.14-2.146 3.029-1.357.697.622 3.037 1.896 3.751 2.426.862.641 1.226 1.343.46 2.026z"/><path stroke="var(--color1,gray)" strokeWidth="1.882" d="M27.356 13.091c0 .146-.113.306-.04.424 1.312 2.097-.606 1.168-2.274 1.844-2.371.963-3.332 1.969-2.034-1.184.107-.351-.281-.691-.281-1.084 0-.921.559-1.715 1.365-2.069.29-.128.61-.199.95-.199 1.278 0 2.313 1.015 2.313 2.268z"/><path stroke="var(--color1,gray)" strokeWidth="1.882" d="M24.327 8.394c.821 1.829-.774 3.697-2.921 3.226-.81-.178-1.541-.726-2.235-1.149-.603-.368-1.179-1.459-.687-2.078.715-.897 1.794-1.796 1.684-2.922-.041-.422.796-.324 1.238-.304.368.016.644.374 1.026.375 2.947.015 1.359 1.659 1.894 2.851zM32.055 6.734c0 .815-.244 1.569-.663 2.19-.665.987-1.897 1.075-3.013 1.632-1.807.901-3.6.032-3.122-1.301.35-.981.329-2.234-.075-3.31-.315-.838.234-1.937.731-2.046.571-.124 1.541-.118 2.466-.987 1.138-1.071 2.899 1.013 3.429 2.443.159.428.247.893.247 1.379z"/></svg>);
      case ('alert'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 438.533 438.533"><path d="M409.133 109.203c-19.608-33.592-46.205-60.189-79.798-79.796C295.736 9.801 259.058 0 219.273 0c-39.781 0-76.466 9.801-110.063 29.407-33.595 19.604-60.192 46.201-79.8 79.796C9.801 142.8 0 179.489 0 219.267s9.804 76.463 29.407 110.062c19.607 33.585 46.204 60.189 79.799 79.798 33.597 19.605 70.283 29.407 110.063 29.407s76.47-9.802 110.065-29.407c33.593-19.602 60.189-46.206 79.795-79.798 19.603-33.599 29.403-70.287 29.403-110.062.001-39.778-9.8-76.472-29.399-110.064zM255.82 356.021c0 2.669-.862 4.9-2.573 6.707s-3.806 2.711-6.283 2.711h-54.818c-2.472 0-4.663-.952-6.565-2.854-1.904-1.903-2.854-4.093-2.854-6.563V301.78c0-2.478.95-4.668 2.854-6.571 1.903-1.902 4.093-2.851 6.565-2.851h54.818c2.478 0 4.579.907 6.283 2.707 1.711 1.817 2.573 4.045 2.573 6.715v54.241zm-.574-98.209c-.192 1.902-1.188 3.568-2.991 4.996-1.813 1.424-4.045 2.135-6.708 2.135h-52.822c-2.666 0-4.95-.711-6.853-2.135-1.904-1.428-2.857-3.094-2.857-4.996L178.162 80.51c0-2.288.95-3.997 2.852-5.14 1.906-1.521 4.19-2.284 6.854-2.284h62.819c2.666 0 4.948.76 6.851 2.284 1.903 1.143 2.848 2.856 2.848 5.14l-5.14 177.302z"/></svg>);
      case ('arrows'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 18.3 21.6"><path d="M8.5.2c-.4.3-.5.9-.1 1.4l7.7 9.2L8.4 20c-.3.4-.3 1 .1 1.4.4.3 1 .3 1.4-.1l8.2-9.9c.1-.2.2-.4.2-.6 0-.2-.1-.4-.2-.6L9.9.3c-.4-.4-1-.4-1.4-.1z"/><path d="M.4.2c-.4.3-.5.9-.1 1.4L8 10.8.3 20c-.3.4-.3 1 .1 1.4.4.3 1 .3 1.4-.1l8.2-9.9c.1-.2.2-.4.2-.6 0-.2-.1-.4-.2-.6L1.8.3C1.4-.1.8-.1.4.2z"/></svg>);
      case ('attachment'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><path d="M512 363.8c0-35-12-70.6-39-97.5L233.4 28.6c-6.3-7-18.8-7.5-25.5-.7-7 6-7 19 1 25l239 238c20 19 29 45 29 72 0 51-45 90-96 90-24 0-49-10-68-29L52 164c-11-11-17-25-17-38.2 0-17 5.2-33 17.4-45.3C75.8 57 112.6 57 136 80.5l258.7 259c10 11.5 10.4 25.2 2.7 34-11 8.7-25 7.7-32.5.6L128 140c-6.3-7-18.8-7.5-25.5-.7-6.7 6.8-6.3 19 1 25.5l236 235c28 22 62.2 22.4 81.7-.2 22-22.7 19-58.4-.8-82-90.7-90.7-183-183-260.6-261C124 19 64.3 19 27.8 56 8 75.3 0 101.3 0 125.7c0 24 11 46.4 28 63.4l261.3 261c25.2 25 58.2 39 91.8 39 70 0 131-53 131-125z"/></svg>);
      case ('bag'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 307.09 307.09"><path d="M253.64 272.134c17.923-48.31 17.923-188.87.002-237.178L258.9 7.113A5.998 5.998 0 0 0 253.004 0H54.092a5.999 5.999 0 0 0-5.894 7.112l5.254 27.843C35.527 83.26 35.527 223.82 53.448 272.133l-5.26 27.844a6.006 6.006 0 0 0 1.277 4.942 6.003 6.003 0 0 0 4.62 2.17h198.932a6 6 0 0 0 5.784-7.604l-5.16-27.352zM245.767 12l-3.306 17.502H64.63L61.33 12h184.436zM63.856 41.502h179.376c15.81 46.86 15.81 177.222 0 224.086H63.857c-15.81-46.864-15.81-177.227 0-224.086zM61.324 295.09l3.306-17.502h177.83l3.3 17.502H61.325z"/><path d="M90.81 201.64c.017.003.033.005.05.01.117.015.23.04.348.055.467.058.945.086 1.465.086 4.005 0 9.993-1.792 19.434-4.718 9.128-2.83 19.475-6.037 26.243-6.417a35.03 35.03 0 0 1 1.964-.054c5.49 0 10.985 1.276 16.802 2.627 6.976 1.62 14.882 3.455 24.263 3.455 7.652 0 26.803-1.405 39.3-14.426 7.393-7.702 10.886-17.837 10.382-30.123-1.382-33.63-37.866-48.176-56.172-48.176-27.818 0-43.31 22.91-48.825 37.854-37.452 5.467-50.08 35.79-50.08 43.81-.004 8.62 5.67 14.72 14.825 16.02zm84.078-85.683c12.56 0 43.108 10.55 44.182 36.668.365 8.895-2.007 16.068-7.05 21.32-9.56 9.962-25.87 10.736-30.643 10.736-8.006 0-14.89-1.598-21.55-3.144-6.218-1.443-12.648-2.937-19.515-2.937-.883 0-1.77.024-2.637.072-5.018.28-11.092 1.668-17.285 3.393 9.676-13.714 14.996-30.023 15.913-32.98.01-.028.014-.058.023-.088.006-.02.016-.036.02-.055.385-1.344 9.75-32.985 38.542-32.985zM121.35 155c-5.723 13.707-16.432 32.816-29.38 34.684-3.982-.712-3.988-2.71-3.99-4.02.17-3.17 7.886-24.03 33.37-30.664z"/></svg>);
      case ('calendar'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 24 24"><path d="M12 20.016c3.891 0 6.984-3.141 6.984-7.031s-3.094-6.984-6.984-6.984-6.984 3.094-6.984 6.984 3.094 7.031 6.984 7.031zM12 3.984c5.016 0 9 3.984 9 9s-3.984 9-9 9-9-3.984-9-9 3.984-9 9-9zM12.516 8.016v5.297l3.984 2.391-0.797 1.219-4.688-2.906v-6h1.5zM7.922 3.422l-4.641 3.797-1.266-1.5 4.594-3.797zM21.984 5.719l-1.266 1.5-4.641-3.938 1.313-1.5z"/>></svg>);
      case ('cement'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 23 32"><title>cement</title><path fill="var(--color1,gray)" d="M9.682 7.32l2.343-2.779h-1.017L8.667 7.32zM12.015 7.32l2.341-2.779h-1.015L11 7.32z"/><path stroke="var(--color1,gray)" d="M5.283 22.997h12.381M7.188 24.902h9.524"/><path stroke="var(--color1,gray)" strokeWidth="1.199" d="M11.303 20.875c-2.75 0-5-2.25-5-5s2.25-4.999 5-4.999 5 2.25 5 4.999c0 2.75-2.25 5-5 5z"/><path stroke="var(--color1,gray)" strokeWidth="1.351" strokeLinecap="round" d="M2.73 1.909l1.245 1.108M20.236 1.909l-1.245 1.108M2.73 30.307l1.245-1.108M20.236 30.307l-1.245-1.108"/><path stroke="var(--color1,gray)" strokeWidth="1.333" d="M19.953 30.557a45.058 45.058 0 0 0-16.94 0 1.203 1.203 0 0 1-1.203-1.203V2.631c0-.664.538-1.203 1.203-1.203h16.94c.665 0 1.203.539 1.203 1.203v26.723c0 .664-.538 1.203-1.203 1.203z"/><path fill="var(--color1,gray)" d="M20.683 2.185H2.214a.261.261 0 0 1-.261-.26v-.032c0-.144.117-.261.261-.261h18.469a.26.26 0 0 1 .26.261v.032a.26.26 0 0 1-.26.26z"/><path stroke="var(--color1,gray)" strokeWidth="1.199" d="M15.955 14.049h5.201M1.778 14.049H6.65"/><path stroke="var(--color1,gray)" strokeWidth="1.333" d="M16.039 17.472h5.117M6.567 17.472H1.81M11.303 19.253c-1.858 0-3.378-1.52-3.378-3.378s1.52-3.379 3.378-3.379 3.378 1.521 3.378 3.379-1.52 3.378-3.378 3.378z"/></svg>);
      case ('check'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 74 74"><path d="M39.4 53.6L27.7 65.3 1.4 39l11.7-11.7 14.6 14.6L60.9 8.7l11.7 11.7-33.2 33.2z"/></svg>);
      case ('check-circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 100 100"><path d="M50 .3C22.6.3.3 22.6.3 50 .3 77.4 22.5 99.7 50 99.7c27.4 0 49.7-22.2 49.7-49.7C99.7 22.6 77.4.3 50 .3zm2.4 66.3L40.7 78.3 14.4 52l11.7-11.7 14.6 14.6 33.2-33.2 11.7 11.7-33.2 33.2z"/></svg>);
      case ('chevron'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="-253 252.5 4.5 9.5"><title>whiteArrow</title><path d="M-252.9 252.6c-.2.1-.2.4-.1.6l3.4 4.1-3.4 4.1c-.1.2-.1.4.1.6.2.1.4.1.6-.1l3.6-4.3c.1-.2.1-.4 0-.5l-3.6-4.3c-.1-.3-.4-.4-.6-.2.1 0 .1 0 0 0z"/></svg>);
      case ('clear'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><path d="M512 116.4v279.2c-.3.8-.8 1.5-.9 2.3-5.9 32.6-32.6 55.1-65.5 55.1-75.9 0-151.9.2-227.8-.1-22.2-.1-42.1-8.1-57.9-23.7-50-49.4-99.5-99.3-149.2-149-14.3-14.3-14.3-34 0-48.4 49.6-49.8 99.2-99.6 149.2-149 15.5-15.4 35-23.6 56.9-23.7 76.6-.4 153.2-.2 229.8-.1 30.4 0 56.4 20.9 63.6 50.6.5 2.3 1.2 4.6 1.8 6.8m-196.4 94.1c-17.1-17.2-32.9-33.1-48.7-48.9-9.1-9.1-18-18.3-27.2-27.2-13.4-12.8-32.7-13-45.8-.7-13.8 13-13.8 33.7.3 48 22.5 22.7 45.2 45.2 67.8 67.9 2.1 2.1 4.2 4.3 6.7 6.9-2 1.8-3.7 3.1-5.1 4.5-23.2 23.2-46.5 46.4-69.6 69.6-9.6 9.7-12.9 21.2-8.6 34.3 7.8 23.6 36.8 30.1 54.9 12.3 23.7-23.5 47.2-47.1 70.8-70.7 1.3-1.3 2.6-2.5 4.4-4.1 1.6 1.8 2.7 3.3 4.1 4.7 23.2 23.2 46.4 46.4 69.6 69.7 8.3 8.3 18.1 12.3 29.7 10.2 12.8-2.3 21.7-9.8 25.8-22.2 4.2-12.9 1-24.3-8.5-33.9-23.5-23.6-47.1-47.2-70.7-70.8-1.3-1.3-2.5-2.6-4.2-4.5 1.8-1.6 3.4-2.7 4.7-4 23.2-23.2 46.4-46.4 69.7-69.6 6.3-6.3 10.2-13.6 10.7-22.6.7-13.6-6.9-26.1-19.3-31.7-12.7-5.7-26.7-3.2-36.9 6.9-23.7 23.5-47.2 47.1-70.7 70.7-1.5 1.2-2.3 3-3.9 5.2"/></svg>);
      case ('close'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 8 8"><path d="M4 4L7.1.9V.7h-.2l-3 3.1L.7.7H.5C.4.7.5.8.5.9L3.7 4 .5 7.2v.2h.2l3.1-3.1 3.2 3h.2v-.2L4 4z"/></svg>);
      case ('content_copy'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 27 32"><path d="M19.733 1.333h-16A2.675 2.675 0 0 0 1.066 4v18.667h2.667V4h16V1.333zm4 5.334H9.066a2.675 2.675 0 0 0-2.667 2.667v18.667c0 1.467 1.2 2.667 2.667 2.667h14.667c1.467 0 2.667-1.2 2.667-2.667V9.334c0-1.467-1.2-2.667-2.667-2.667zm0 21.333H9.066V9.333h14.667V28z"/></svg>);
      case ('delete'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 27 32"><path d="M2.923 28.444C2.923 30.4 4.523 32 6.479 32h14.222c1.956 0 3.556-1.6 3.556-3.556V7.111H2.924v21.333zM26.034 1.778h-6.222L18.034 0H9.145L7.367 1.778H1.145v3.556h24.889V1.778z"/></svg>);
      case ('edit'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><g fillRule="evenodd" clipRule="evenodd"><path d="M256 202.7V256h53.3L466.6 98.7l-53.3-53.3zM507.9 37.4L474.6 4.2c-5.5-5.5-14.5-5.5-20.1 0l-25.4 25.4 52.6 54 26.1-26.1c5.6-5.6 5.6-14.5.1-20.1z"/></g><path d="M425.7 485.9c0 1.1-1 2.1-2.1 2.1H25.8c-1.1 0-2.1-1-2.1-2.1V88.1c0-1.1 1-2.1 2.1-2.1H285V63H25.8C12 63 .7 74.3.7 88.1v397.8C.7 499.7 12 511 25.8 511h397.8c13.8 0 25.1-11.3 25.1-25.1V225.5h-23"/><path fillRule="evenodd" clipRule="evenodd" d="M350.3 342.7c5.7 0 10.4 4.9 10.4 10.5 0 5.8-4.8 10.5-10.4 10.5H97.5c-5.7 0-10.4-4.9-10.4-10.5 0-5.8 4.7-10.5 10.4-10.5h252.8zM97.5 405.8h252.8c5.7 0 10.4 4.9 10.4 10.5 0 5.8-4.7 10.5-10.4 10.5H97.5c-5.7 0-10.4-4.9-10.4-10.5 0-5.8 4.8-10.5 10.4-10.5z"/></svg>);
      case ('edit2'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><path d="M128 330.7V384h53.3l157.3-157.3-53.3-53.3zM379.9 165.4l-33.3-33.2c-5.5-5.5-14.5-5.5-20.1 0l-25.4 25.4 52.6 54 26.1-26.1c5.6-5.6 5.6-14.5.1-20.1z"/></svg>);
      case ('envelope'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 80 80"><path d="M21.7 53.7V27.8L40.3 43l18.6-15.2v25.9H21.7zm35.8-27L40.3 40.8 23 26.7h34.5zM20 55.4h40.5V25H20v30.4z"/></svg>);
      case ('excel'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><path d="M511.9 158.6c0-2.7-1.3-5.9-3-8-41.1-48.2-82.3-96.2-123.5-144.3-1.7-2-3.2-4.2-4.7-6.3H144.2c-6.1 3.3-12.7 5.9-18.2 10-13 9.7-20.3 23.1-20.8 39.5s-.3 55.3-.3 55.3H.4V436h104.7c0 5.6.1 10.5 0 15.5-.2 10.8 1.7 21.1 6.4 30.7 7.1 14.7 17.8 25.5 34.3 29 3.2.7 6.6.8 9.9.8h301c32.3 0 55.2-23 55.2-55.5.1-99.3.1-198.6 0-297.9zM33.1 403V138h279.3v265H33.1zm414 72.5c-39.2.1-78.5 0-117.7 0-53.1 0-106.2-.1-159.3-.1-21.2 0-35.2-17.2-31.5-39H345V104.8l-207.2-.1s-.1-27.4 0-38.8c.2-17.8 13.1-30.7 30.8-30.8 36.2-.1 72.5-.1 108.7-.1h79.3v88.8c.1 35.2 26.1 61.4 61.1 61.5 19.4.1 38.7 0 58.1 0h1.1V456c-4.3 11.7-15.6 19.5-29.8 19.5z"/><path d="M202.1 270.4c-2.4-3.1-2.4-5 0-8.1 18.3-23.6 36.4-47.3 54.5-71 1-1.3 1.9-2.8 3.4-4.9-19.7 0-38.2-.1-56.8.1-1.5 0-3.5 1.7-4.5 3.2-8.1 11.7-16 23.6-23.9 35.4-1 1.4-2.1 2.8-3.5 4.7-8.6-13.6-16.8-26.5-24.8-39.5-1.8-2.9-3.7-4.1-7.1-4-16.2.2-32.4.1-48.7.1-1.4 0-2.8.2-4.8.3 1.4 2 2.4 3.5 3.4 5 17.1 23.4 34.2 46.9 51.4 70.2 2.3 3.2 2.7 5.1 0 8.5-21.5 26.8-42.8 53.8-64.1 80.7-1.5 1.9-3 3.9-4.9 6.3 2.3.1 3.8.2 5.2.2 15.9 0 31.8-.1 47.7.1 3.6 0 5.7-1.2 7.8-4.1 11.6-16 23.5-31.8 35.2-47.7 1-1.4 2.2-2.7 3.6-4.5 1.5 2 2.6 3.5 3.7 5 11.2 15.9 22.4 31.8 33.7 47.6 1.1 1.6 3.2 3.5 4.8 3.5 18 .3 36.1.2 55.1.2-1.9-2.6-3-4.2-4.2-5.8-20.7-27.2-41.4-54.4-62.2-81.5z"/></svg>);
      case ('marker'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="82 167 353 332"><path d="M258.5 169.7c-63.1 0-114.3 51.2-114.3 114.3 0 85.7 114.3 212.2 114.3 212.2S372.8 369.8 372.8 284c0-63.1-51.2-114.3-114.3-114.3zm0 155.1c-22.5 0-40.8-18.3-40.8-40.8s18.3-40.8 40.8-40.8 40.8 18.3 40.8 40.8-18.3 40.8-40.8 40.8z"/></svg>);
      case ('minus'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="-191 193 128 128"><path d="M-190 252h126v10h-126z"/></svg>);
      case ('notification'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 12 12"><path d="M6 1C3.2 1 1 3.2 1 6s2.2 5 5 5 5-2.2 5-5-2.2-5-5-5zm.5 8h-1V7.5h1V9zm0-2.5h-1v-4h1v4z"/></svg>);
      case ('plus'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="-249 250.1 12.1 12.9"><path d="M-242.3 255.8h5.4v1.4h-5.4v5.9h-1.5v-5.9h-5.3v-1.4h5.3v-5.7h1.5v5.7z"/></svg>);
      case ('readymix'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 44 32"><title>Readymix</title><path stroke="var(--color4,#000)" d="M12.982 25.035h1.943"/><path fill="var(--color5,#6b6d6f)" d="M0 28.787h1.432v-4.809H0zM9.461 28.328a2.83 2.83 0 1 1-5.66.001 2.83 2.83 0 0 1 5.66-.001zM25.892 28.328a2.83 2.83 0 1 1-5.66.001 2.83 2.83 0 0 1 5.66-.001zM38.878 28.328a2.83 2.83 0 1 1-5.66.001 2.83 2.83 0 0 1 5.66-.001z"/><path stroke="var(--color6,#fff)" strokeWidth="1.778" d="M12.982 20.105h1.943"/><path stroke="var(--color5,#6b6d6f)" strokeWidth="1.778" strokeLinecap="round" d="M1.141 28.114h11.65v-12.94H1.141z"/><path stroke="var(--color5,#6b6d6f)" strokeWidth="1.778" strokeLinecap="round" d="M3.061 21.296h7.809v-4.07H3.061zM12.791 28.114h30.593v-3.08H12.791"/><path stroke="var(--color5,#6b6d6f)" strokeWidth="1.778" d="M43.659 27.033v1.755M12.982 17.599h1.943M12.982 22.451h1.943M12.982 20.025h1.943M12.982 15.174h1.943"/><path stroke="var(--color5,#6b6d6f)" strokeWidth="1.778" strokeLinecap="round" d="M12.791 14.858V9.511l1.518-2.012h2.263l-1.518 2.012v15.364M23.879 22.726l-3.793-14.4-3.503 5.467 1.574 5.977zM25.986 23.066l5.617-1.483L27.258 5.33l-5.617 1.483 4.279 16.253M41.526 12.48l-8.277 7.916-3.896-14.795 11.261 2.715z"/><path stroke="var(--color5,#6b6d6f)" strokeWidth="1.744" d="M39.41 8.107l1.259 5.215"/><path stroke="var(--color5,#6b6d6f)" strokeWidth="1.744" strokeLinecap="round" d="M40.158 14.197v3.65l1.732 1.732v.035l-3.112 3.111h-.054l-2.676-2.675v-2.038M35.957 6.509V2.008h4.11V7.5"/></svg>);
      case ('redo'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><path d="M511.6 512V409.7H220.1c-16.9 0-33.6-1.8-49.5-7.8-40.6-15.3-61.3-46.1-67-88-2.5-18.2-1.6-36.3 2.8-54.2 11-44.8 46-74.9 92.1-79.2 8.1-.8 16.3-1.1 24.5-1.2 34.2-.1 68.4-.1 102.5-.1h7.1V256c60.1-43 119.3-85.2 179.2-128C452.4 85.6 393.2 43.3 333.1.4v76.7h-7.7c-34.2 0-68.4.3-102.5-.1-50.2-.6-94.5 15.9-133.7 46.4C48.6 154.8 20.3 195 6.9 244.7c-14.7 54.9-5.5 106.7 23.7 154.8C64.3 455 112.2 492.1 175.8 507c14.4 3.4 29.7 4.7 44.5 4.7 94.9.4 189.9.2 284.9.2h6.4z"/></svg>);
      case ('repeat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 28 32"><path d="M6.815 8.593H21.63v4.444l5.926-5.926-5.926-5.926v4.444H3.852v8.889h2.963V8.592zM21.63 23.407H6.815v-4.444L.889 24.889l5.926 5.926v-4.444h17.778v-8.889H21.63v5.926z"/></svg>);
      case ('search'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 60 60"><path d="M57.6 54.9L42.9 40.4c3.5-4.1 5.5-9.3 5.5-14.7.2-12.8-10-23.4-22.8-23.6C12.8 1.8 2.2 12.1 2 24.9c-.2 12.8 10 23.4 22.8 23.6h.4c5.5 0 10.8-1.9 15-5.4l14.7 14.5c.5.5 1.3.5 1.8 0l.9-.9c.5-.5.5-1.3 0-1.8zM25.5 44.7h-.3C14.6 44.7 6 36.2 5.9 25.6 5.7 15 14.2 6.2 24.9 6s19.5 8.4 19.6 19c.2 10.7-8.3 19.5-19 19.7z"/><path d="M35.5 16.1H14.9c-.7 0-1.3.6-1.3 1.3v1.3c0 .7.6 1.3 1.3 1.3h20.7c.7 0 1.3-.6 1.3-1.3v-1.3c-.1-.7-.7-1.3-1.4-1.3zM33 23.7H17.5c-.7 0-1.3.6-1.3 1.3v1.3c0 .5.3 1 .8 1.2.2.1.3.1.5.1h15.4c.7 0 1.3-.6 1.3-1.3V25c0-.2 0-.3-.1-.5-.2-.4-.6-.8-1.1-.8zM30.4 31.3H20.1c-.7 0-1.3.6-1.3 1.3v1.3c0 .7.6 1.3 1.3 1.3h10.3c.7 0 1.3-.6 1.3-1.3v-1.3c0-.7-.6-1.3-1.3-1.3z"/></svg>);
      case ('star'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 489.914 489.914"><path d="M483.871 204.522a17.744 17.744 0 0 0 5.123-18.98 17.763 17.763 0 0 0-15.53-12.07l-142.249-10.618c-6.607-.502-12.376-4.609-14.982-10.682L259.738 21.184c-2.838-6.555-9.331-10.793-16.484-10.714a17.744 17.744 0 0 0-16.259 11.021l-54.056 132.016a17.736 17.736 0 0 1-14.792 10.956l-142.04 13.245a17.748 17.748 0 0 0-15.29 12.343 17.791 17.791 0 0 0 5.461 18.884l108.845 92.216a17.786 17.786 0 0 1 5.851 17.452L89.682 457.786a17.767 17.767 0 0 0 7.023 18.369 17.77 17.77 0 0 0 19.658.627l121.315-75.039a17.761 17.761 0 0 1 18.417-.159l122.686 72.767c6.14 3.642 13.888 3.256 19.624-.998 5.738-4.254 8.381-11.555 6.671-18.496l-33.839-138.575a17.743 17.743 0 0 1 5.511-17.561l107.123-94.199z"/></svg>);
      case ('success'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 74 74">
        <path d="M39.4 53.6L27.7 65.3 1.4 39l11.7-11.7 14.6 14.6L60.9 8.7l11.7 11.7-33.2 33.2z"/>
      </svg>);
      case ('times'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 128 128"><path d="M81.646 64l22.248-22.249c3.48-3.48 3.474-9.131-.019-12.623l-5.006-5.005c-3.489-3.49-9.142-3.499-12.622-.019L64 46.354 41.753 24.106c-3.484-3.483-9.133-3.472-12.624.018l-5.005 5.005c-3.491 3.492-3.501 9.14-.018 12.623L46.354 64 24.108 86.246c-3.483 3.484-3.472 9.133.018 12.623l5.005 5.006c3.492 3.492 9.14 3.502 12.623.018L64 81.647l22.247 22.246c3.48 3.481 9.131 3.475 12.622-.019l5.006-5.006c3.489-3.489 3.498-9.142.019-12.622L81.646 64z" /></svg>);
      case ('truck'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><path d="M43 85.834l-10.608 1.56L0 250.245l9.204 5.5c.573.344 12.594 7.46 36.928 17.04L83.64 84.225c-26.147-.462-39.978 1.513-40.64 1.61zm414.52 103.519h-12.655v77.71h60.43"/><path d="M414.45 297.477V189.353h-52.674l6.972-35.053-9.204-5.502c-.573-.343-12.595-7.46-36.928-17.04l-33.49 168.36h-31.01l35.558-178.76c-26.902-8.845-56.632-16.53-88.65-22.9-32.02-6.37-62.427-10.645-90.665-12.768L75.073 283.183c18.98 6.24 39.37 11.904 60.977 16.935H47.146v85.423h55.75c.053 23.338 19.052 42.307 42.4 42.307 23.35 0 42.35-18.97 42.402-42.306h14.262c.052 23.338 19.05 42.307 42.4 42.307 23.35 0 42.35-18.97 42.4-42.306h99.908c.053 23.338 19.05 42.307 42.4 42.307s42.35-18.97 42.402-42.306H512v-88.063h-97.55zm-63.064 2.64h-11.644l11.644-58.534v58.535z"/></svg>);
      case ('undo'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512"><path d="M.4 512V409.7h291.5c16.9 0 33.6-1.8 49.5-7.8 40.6-15.3 61.3-46.1 67-88 2.5-18.2 1.6-36.3-2.8-54.2-11-44.8-46-74.9-92.1-79.2-8.1-.8-16.3-1.1-24.5-1.2-34.2-.1-68.4-.1-102.5-.1h-7.1V256C119 213.2 59.9 171 0 128.2 59.6 85.6 118.8 43.3 178.9.4v76.7h7.7c34.2 0 68.4.3 102.5-.1 50.2-.6 94.5 15.9 133.7 46.4 40.5 31.5 68.9 71.6 82.2 121.4 14.7 54.9 5.5 106.7-23.7 154.8-33.6 55.4-81.5 92.5-145.1 107.4-14.4 3.4-29.7 4.7-44.5 4.7-94.9.4-189.9.2-284.9.2H.4z"/></svg>);
      case ('alarm'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} viewBox="0 0 512 512">
      ...
      case ('access_alarms'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color}>
      ...
      case ('schedule'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12.516 6.984v5.25l4.5 2.672-0.75 1.266-5.25-3.188v-6h1.5zM12 20.016c4.406 0 8.016-3.609 8.016-8.016s-3.609-8.016-8.016-8.016-8.016 3.609-8.016 8.016 3.609 8.016 8.016 8.016zM12 2.016c5.531 0 9.984 4.453 9.984 9.984s-4.453 9.984-9.984 9.984-9.984-4.453-9.984-9.984 4.453-9.984 9.984-9.984z"></path>
      </svg>);
      case ('accessibility'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('accessible'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('account_balance'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('account_balance_wallet'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('account_box'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('account_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 19.219c2.484 0 4.688-1.313 6-3.234-0.047-1.969-4.031-3.094-6-3.094-2.016 0-5.953 1.125-6 3.094 1.313 1.922 3.516 3.234 6 3.234zM12 5.016c-1.641 0-3 1.359-3 3s1.359 3 3 3 3-1.359 3-3-1.359-3-3-3zM12 2.016c5.531 0 9.984 4.453 9.984 9.984s-4.453 9.984-9.984 9.984-9.984-4.453-9.984-9.984 4.453-9.984 9.984-9.984z"></path>
      </svg>);

      case ('adb'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('add'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18.984 12.984h-6v6h-1.969v-6h-6v-1.969h6v-6h1.969v6h6v1.969z"></path>
      </svg>);

      case ('add_a_photo'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('alarm_add'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('add_alert'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('add_box'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('add_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('control_point'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('add_location'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('add_shopping_cart'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('queue'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('add_to_queue'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('adjust'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_flat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_flat_angled'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_individual_suite'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_legroom_extra'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_legroom_normal'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_legroom_reduced'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_recline_extra'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airline_seat_recline_normal'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flight'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airplanemode_inactive'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airplay'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('airport_shuttle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('alarm_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('alarm_on'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('album'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('all_inclusive'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('all_out'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('android'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('announcement'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('apps'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('archive'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('arrow_back'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M20.016 11.016v1.969h-12.188l5.578 5.625-1.406 1.406-8.016-8.016 8.016-8.016 1.406 1.406-5.578 5.625h12.188z"></path>
      </svg>);

      case ('arrow_downward'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M20.016 12l-8.016 8.016-8.016-8.016 1.453-1.406 5.578 5.578v-12.188h1.969v12.188l5.625-5.578z"></path>
      </svg>);

      case ('arrow_drop_down'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6.984 9.984h10.031l-5.016 5.016z"></path>
      </svg>);

      case ('arrow_drop_down_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('arrow_drop_up'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6.984 14.016l5.016-5.016 5.016 5.016h-10.031z"></path>
      </svg>);

      case ('arrow_forward'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 3.984l8.016 8.016-8.016 8.016-1.406-1.406 5.578-5.625h-12.188v-1.969h12.188l-5.578-5.625z"></path>
      </svg>);

      case ('arrow_upward'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3.984 12l8.016-8.016 8.016 8.016-1.453 1.406-5.578-5.578v12.188h-1.969v-12.188l-5.625 5.578z"></path>
      </svg>);

      case ('art_track'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('aspect_ratio'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('poll'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('assignment'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('assignment_ind'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('assignment_late'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('assignment_return'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('assignment_returned'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('assignment_turned_in'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('assistant'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flag'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M14.391 6h5.625v9.984h-7.031l-0.375-1.969h-5.625v6.984h-1.969v-17.016h9z"></path>
      </svg>);

      case ('attach_file'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('attach_money'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('attachment'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('audiotrack'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('autorenew'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('av_timer'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('backspace'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cloud_upload'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('battery_alert'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('battery_charging_full'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('battery_std'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('battery_unknown'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('beach_access'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('beenhere'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('block'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('bluetooth'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('bluetooth_searching'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('bluetooth_connected'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('bluetooth_disabled'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('blur_circular'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('blur_linear'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('blur_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('blur_on'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('class'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('turned_in'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('turned_in_not'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_all'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_bottom'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_clear'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_color'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_horizontal'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_inner'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_left'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_outer'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_right'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_style'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_top'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('border_vertical'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('branding_watermark'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_1'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_2'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_3'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_4'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_low'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_medium'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_high'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brightness_auto'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('broken_image'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('brush'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('bubble_chart'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('bug_report'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('build'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('burst_mode'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('domain'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('business_center'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cached'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cake'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6.609 10.781c1.453 2.813 3.797 5.156 6.609 6.609l2.203-2.203c0.281-0.281 0.703-0.375 1.031-0.234 1.125 0.375 2.344 0.563 3.563 0.563 0.563 0 0.984 0.422 0.984 0.984v3.516c0 0.563-0.422 0.984-0.984 0.984-9.375 0-17.016-7.641-17.016-17.016 0-0.563 0.422-0.984 0.984-0.984h3.516c0.563 0 0.984 0.422 0.984 0.984 0 1.266 0.188 2.438 0.563 3.563 0.094 0.328 0.047 0.75-0.234 1.031z"></path>
      </svg>);

      case ('call_end'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('call_made'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9 5.016h9.984v9.984h-1.969v-6.609l-11.625 11.625-1.406-1.406 11.625-11.625h-6.609v-1.969z"></path>
      </svg>);

      case ('merge_type'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('call_missed'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M19.594 6.984l1.406 1.406-9 9-6.984-6.984v4.594h-2.016v-8.016h8.016v2.016h-4.594l5.578 5.578z"></path>
      </svg>);

      case ('call_missed_outgoing'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3 8.391l1.406-1.406 7.594 7.594 5.578-5.578h-4.594v-2.016h8.016v8.016h-2.016v-4.594l-6.984 6.984z"></path>
      </svg>);

      case ('call_received'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M20.016 5.391l-11.625 11.625h6.609v1.969h-9.984v-9.984h1.969v6.609l11.625-11.625z"></path>
      </svg>);

      case ('call_split'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('call_to_action'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('camera'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo_camera'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('camera_enhance'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('camera_front'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('camera_rear'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('camera_roll'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cancel'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('redeem'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('card_membership'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('card_travel'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('casino'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cast'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cast_connected'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('center_focus_strong'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('center_focus_weak'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('change_history'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 3.984l9.984 16.031h-19.969zM12 7.781l-6.375 10.219h12.75z"></path>
      </svg>);

      case ('chat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('chat_bubble'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('chat_bubble_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('check'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9 16.172l10.594-10.594 1.406 1.406-12 12-5.578-5.578 1.406-1.406z"></path>
      </svg>);

      case ('check_box'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('check_box_outline_blank'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('check_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('navigate_before'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.422 7.406l-4.594 4.594 4.594 4.594-1.406 1.406-6-6 6-6z"></path>
      </svg>);

      case ('navigate_next'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9.984 6l6 6-6 6-1.406-1.406 4.594-4.594-4.594-4.594z"></path>
      </svg>);

      case ('child_care'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('child_friendly'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('chrome_reader_mode'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('close'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18.984 6.422l-5.578 5.578 5.578 5.578-1.406 1.406-5.578-5.578-5.578 5.578-1.406-1.406 5.578-5.578-5.578-5.578 1.406-1.406 5.578 5.578 5.578-5.578z"></path>
      </svg>);

      case ('clear_all'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('closed_caption'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wb_cloudy'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cloud_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cloud_done'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cloud_download'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cloud_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('cloud_queue'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('code'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo_library'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('collections_bookmark'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('palette'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('colorize'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('comment'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('compare'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('compare_arrows'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('laptop'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('confirmation_number'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('contact_mail'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('contact_phone'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('contacts'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('content_copy'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('content_cut'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('content_paste'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('control_point_duplicate'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('copyright'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mode_edit'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('create_new_folder'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('payment'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_16_9'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_3_2'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_landscape'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_7_5'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_din'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_free'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_original'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_portrait'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_rotate'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('crop_square'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('dashboard'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('data_usage'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('date_range'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('dehaze'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M2.016 5.484h19.969v2.016h-19.969v-2.016zM2.016 10.5h19.969v2.016h-19.969v-2.016zM2.016 15.516h19.969v1.969h-19.969v-1.969z"></path>
      </svg>);

      case ('delete'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('delete_forever'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('delete_sweep'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('description'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('desktop_mac'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('desktop_windows'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('details'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6.375 6l5.625 9.984 5.625-9.984h-11.25zM3 3.984h18l-9 16.031z"></path>
      </svg>);

      case ('developer_board'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('developer_mode'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('device_hub'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phonelink'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('devices_other'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('dialer_sip'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('dialpad'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_bike'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_boat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_bus'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_car'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_railway'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_run'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_transit'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('directions_walk'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('disc_full'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('dns'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('not_interested'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('do_not_disturb_alt'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('do_not_disturb_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('remove_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('dock'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('done'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9 16.219l10.594-10.641 1.406 1.406-12 12-5.578-5.578 1.359-1.406z"></path>
      </svg>);

      case ('done_all'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('donut_large'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('donut_small'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('drafts'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('drag_handle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3.984 15v-2.016h16.031v2.016h-16.031zM20.016 9v2.016h-16.031v-2.016h16.031z"></path>
      </svg>);

      case ('time_to_leave'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('dvr'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('edit_location'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('eject'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 5.016l6.656 9.984h-13.313zM5.016 17.016h13.969v1.969h-13.969v-1.969z"></path>
      </svg>);

      case ('markunread'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M20.016 8.016v-2.016l-8.016 5.016-8.016-5.016v2.016l8.016 4.969zM20.016 3.984c1.078 0 1.969 0.938 1.969 2.016v12c0 1.078-0.891 2.016-1.969 2.016h-16.031c-1.078 0-1.969-0.938-1.969-2.016v-12c0-1.078 0.891-2.016 1.969-2.016h16.031z"></path>
      </svg>);

      case ('enhanced_encryption'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('equalizer'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('error'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('error_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('euro_symbol'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('ev_station'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('insert_invitation'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('event_available'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('event_busy'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('event_note'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('event_seat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('exit_to_app'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('expand_less'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 8.016l6 6-1.406 1.406-4.594-4.594-4.594 4.594-1.406-1.406z"></path>
      </svg>);

      case ('expand_more'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M16.594 8.578l1.406 1.406-6 6-6-6 1.406-1.406 4.594 4.594z"></path>
      </svg>);

      case ('explicit'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('explore'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('exposure'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('exposure_neg_1'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18.984 18h-1.969v-10.641l-3 1.031v-1.688l4.688-1.688h0.281v12.984zM3.984 11.016h8.016v1.969h-8.016v-1.969z"></path>
      </svg>);

      case ('exposure_neg_2'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('exposure_plus_1'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('exposure_plus_2'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('exposure_zero'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('extension'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('face'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fast_forward'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12.984 6l8.531 6-8.531 6v-12zM3.984 18v-12l8.531 6z"></path>
      </svg>);

      case ('fast_rewind'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M11.484 12l8.531-6v12zM11.016 18l-8.531-6 8.531-6v12z"></path>
      </svg>);

      case ('favorite'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('favorite_border'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('featured_play_list'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('featured_video'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sms_failed'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fiber_dvr'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fiber_manual_record'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fiber_new'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fiber_pin'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fiber_smart_record'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('get_app'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M5.016 18h13.969v2.016h-13.969v-2.016zM18.984 9l-6.984 6.984-6.984-6.984h3.984v-6h6v6h3.984z"></path>
      </svg>);

      case ('file_upload'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M5.016 18h13.969v2.016h-13.969v-2.016zM9 15.984v-6h-3.984l6.984-6.984 6.984 6.984h-3.984v6h-6z"></path>
      </svg>);

      case ('filter'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_1'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_2'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_3'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_4'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_5'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M17.016 12.984c0 1.125-0.938 2.016-2.016 2.016h-3.984v-2.016h3.984v-1.969h-3.984v-6h6v1.969h-4.031v2.016h2.016c1.078 0 2.016 0.891 2.016 2.016v1.969zM3 5.016v15.984h15.984v2.016h-15.984c-1.078 0-2.016-0.938-2.016-2.016v-15.984h2.016zM21 17.016v-14.016h-14.016v14.016h14.016zM21 0.984c1.078 0 2.016 0.938 2.016 2.016v14.016c0 1.078-0.938 1.969-2.016 1.969h-14.016c-1.078 0-1.969-0.891-1.969-1.969v-14.016c0-1.078 0.891-2.016 1.969-2.016h14.016z"></path>
      </svg>);

      case ('filter_6'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_7'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_8'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_9'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_9_plus'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_b_and_w'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_center_focus'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_drama'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_frames'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('terrain'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M14.016 6l9 12h-22.031l6-8.016 4.5 6 1.594-1.172-2.813-3.797z"></path>
      </svg>);

      case ('filter_list'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6 12.984v-1.969h12v1.969h-12zM3 6h18v2.016h-18v-2.016zM9.984 18v-2.016h4.031v2.016h-4.031z"></path>
      </svg>);

      case ('filter_none'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21 17.016v-14.016h-14.016v14.016h14.016zM21 0.984c1.078 0 2.016 0.938 2.016 2.016v14.016c0 1.078-0.938 1.969-2.016 1.969h-14.016c-1.078 0-1.969-0.891-1.969-1.969v-14.016c0-1.078 0.891-2.016 1.969-2.016h14.016zM3 5.016v15.984h15.984v2.016h-15.984c-1.078 0-2.016-0.938-2.016-2.016v-15.984h2.016z"></path>
      </svg>);

      case ('filter_tilt_shift'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('filter_vintage'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('find_in_page'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('find_replace'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fingerprint'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('first_page'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6 6h2.016v12h-2.016v-12zM18.422 16.594l-1.406 1.406-6-6 6-6 1.406 1.406-4.594 4.594z"></path>
      </svg>);

      case ('fitness_center'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flare'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flash_auto'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flash_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flash_on'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6.984 2.016h10.031l-4.031 7.969h4.031l-7.031 12v-9h-3v-10.969z"></path>
      </svg>);

      case ('flight_land'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flight_takeoff'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flip'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flip_to_back'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('flip_to_front'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('folder'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('folder_open'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('folder_shared'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('folder_special'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('font_download'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_align_center'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_align_justify'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_align_left'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_align_right'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_bold'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_clear'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_color_fill'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_color_reset'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_color_text'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_indent_decrease'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_indent_increase'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_italic'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9.984 3.984h8.016v3h-2.813l-3.375 8.016h2.203v3h-8.016v-3h2.813l3.375-8.016h-2.203v-3z"></path>
      </svg>);

      case ('format_line_spacing'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_list_bulleted'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_list_numbered'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_paint'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_quote'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M14.016 17.016l1.969-4.031h-3v-6h6v6l-1.969 4.031h-3zM6 17.016l2.016-4.031h-3v-6h6v6l-2.016 4.031h-3z"></path>
      </svg>);

      case ('format_shapes'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_size'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3 12v-3h9v3h-3v6.984h-3v-6.984h-3zM9 3.984h12.984v3h-4.969v12h-3v-12h-5.016v-3z"></path>
      </svg>);

      case ('format_strikethrough'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_textdirection_l_to_r'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_textdirection_r_to_l'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('format_underlined'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('question_answer'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('forward'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 8.016v-4.031l8.016 8.016-8.016 8.016v-4.031h-8.016v-7.969h8.016z"></path>
      </svg>);

      case ('forward_10'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('forward_30'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('forward_5'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('free_breakfast'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('fullscreen'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M14.016 5.016h4.969v4.969h-1.969v-3h-3v-1.969zM17.016 17.016v-3h1.969v4.969h-4.969v-1.969h3zM5.016 9.984v-4.969h4.969v1.969h-3v3h-1.969zM6.984 14.016v3h3v1.969h-4.969v-4.969h1.969z"></path>
      </svg>);

      case ('fullscreen_exit'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.984 8.016h3v1.969h-4.969v-4.969h1.969v3zM14.016 18.984v-4.969h4.969v1.969h-3v3h-1.969zM8.016 8.016v-3h1.969v4.969h-4.969v-1.969h3zM5.016 15.984v-1.969h4.969v4.969h-1.969v-3h-3z"></path>
      </svg>);

      case ('functions'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18 3.984v3h-6.984l4.969 5.016-4.969 5.016h6.984v3h-12v-2.016l6.516-6-6.516-6v-2.016h12z"></path>
      </svg>);

      case ('g_translate'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('games'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('gavel'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('gesture'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('gif'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('goat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('golf_course'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('my_location'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('location_searching'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('location_disabled'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('star'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 17.25l-6.188 3.75 1.641-7.031-5.438-4.734 7.172-0.609 2.813-6.609 2.813 6.609 7.172 0.609-5.438 4.734 1.641 7.031z"></path>
      </svg>);

      case ('gradient'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('grain'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('graphic_eq'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('grid_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('grid_on'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M20.016 8.016v-4.031h-4.031v4.031h4.031zM20.016 14.016v-4.031h-4.031v4.031h4.031zM20.016 20.016v-4.031h-4.031v4.031h4.031zM14.016 8.016v-4.031h-4.031v4.031h4.031zM14.016 14.016v-4.031h-4.031v4.031h4.031zM14.016 20.016v-4.031h-4.031v4.031h4.031zM8.016 8.016v-4.031h-4.031v4.031h4.031zM8.016 14.016v-4.031h-4.031v4.031h4.031zM8.016 20.016v-4.031h-4.031v4.031h4.031zM20.016 2.016c1.078 0 1.969 0.891 1.969 1.969v16.031c0 1.078-0.891 1.969-1.969 1.969h-16.031c-1.078 0-1.969-0.891-1.969-1.969v-16.031c0-1.078 0.891-1.969 1.969-1.969h16.031z"></path>
      </svg>);

      case ('people'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('group_add'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('group_work'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hd'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hdr_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hdr_on'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hdr_strong'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hdr_weak'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('headset'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('headset_mic'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 0.984c4.969 0 9 4.031 9 9v10.031c0 1.641-1.359 3-3 3h-6v-2.016h6.984v-0.984h-3.984v-8.016h3.984v-2.016c0-3.891-3.094-6.984-6.984-6.984s-6.984 3.094-6.984 6.984v2.016h3.984v8.016h-3c-1.641 0-3-1.359-3-3v-7.031c0-4.969 4.031-9 9-9z"></path>
      </svg>);

      case ('healing'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hearing'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('help'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('help_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('high_quality'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('highlight'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('highlight_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('restore'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('home'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9.984 20.016h-4.969v-8.016h-3l9.984-9 9.984 9h-3v8.016h-4.969v-6h-4.031v6z"></path>
      </svg>);

      case ('hot_tub'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_hotel'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hourglass_empty'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('hourglass_full'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6 2.016h12v6l-3.984 3.984 3.984 3.984v6h-12v-6l3.984-3.984-3.984-3.984v-6z"></path>
      </svg>);

      case ('http'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('lock'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('image_aspect_ratio'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('import_contacts'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('import_export'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.984 17.016h3l-3.984 3.984-3.984-3.984h3v-7.031h1.969v7.031zM9 3l3.984 3.984h-3v7.031h-1.969v-7.031h-3z"></path>
      </svg>);

      case ('important_devices'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('inbox'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('indeterminate_check_box'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('info'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('info_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('input'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('insert_comment'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('insert_drive_file'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tag_faces'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('link'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('invert_colors'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('invert_colors_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('iso'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('keyboard'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('keyboard_arrow_down'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M7.406 7.828l4.594 4.594 4.594-4.594 1.406 1.406-6 6-6-6z"></path>
      </svg>);

      case ('keyboard_arrow_left'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.422 16.078l-1.406 1.406-6-6 6-6 1.406 1.406-4.594 4.594z"></path>
      </svg>);

      case ('keyboard_arrow_right'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M8.578 16.359l4.594-4.594-4.594-4.594 1.406-1.406 6 6-6 6z"></path>
      </svg>);

      case ('keyboard_arrow_up'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M7.406 15.422l-1.406-1.406 6-6 6 6-1.406 1.406-4.594-4.594z"></path>
      </svg>);

      case ('keyboard_backspace'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21 11.016v1.969h-14.156l3.563 3.609-1.406 1.406-6-6 6-6 1.406 1.406-3.563 3.609h14.156z"></path>
      </svg>);

      case ('keyboard_capslock'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6 18v-2.016h12v2.016h-12zM12 8.391l-4.594 4.594-1.406-1.406 6-6 6 6-1.406 1.406z"></path>
      </svg>);

      case ('keyboard_hide'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('keyboard_return'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18.984 6.984h2.016v6h-15.188l3.609 3.609-1.406 1.406-6-6 6-6 1.406 1.406-3.609 3.609h13.172v-4.031z"></path>
      </svg>);

      case ('keyboard_tab'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('keyboard_voice'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('kitchen'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('label'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('label_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('language'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('laptop_chromebook'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('laptop_mac'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('laptop_windows'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('last_page'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.984 6h2.016v12h-2.016v-12zM5.578 7.406l1.406-1.406 6 6-6 6-1.406-1.406 4.594-4.594z"></path>
      </svg>);

      case ('open_in_new'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('layers'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('layers_clear'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('leak_add'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('leak_remove'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('lens'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('library_books'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('library_music'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('lightbulb_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('line_style'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('line_weight'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('linear_scale'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('linked_camera'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('list'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('live_help'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('live_tv'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_play'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_airport'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21 15.984l-8.016-2.484v5.484l2.016 1.5v1.5l-3.516-0.984-3.469 0.984v-1.5l1.969-1.5v-5.484l-7.969 2.484v-1.969l7.969-5.016v-5.484c0-0.844 0.656-1.5 1.5-1.5s1.5 0.656 1.5 1.5v5.484l8.016 5.016v1.969z"></path>
      </svg>);

      case ('local_atm'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_bar'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_cafe'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_car_wash'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_convenience_store'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('restaurant_menu'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_drink'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_florist'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_gas_station'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('shopping_cart'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M17.016 18c1.078 0 1.969 0.938 1.969 2.016s-0.891 1.969-1.969 1.969-2.016-0.891-2.016-1.969 0.938-2.016 2.016-2.016zM0.984 2.016h3.281l0.938 1.969h14.813c0.563 0 0.984 0.469 0.984 1.031 0 0.188-0.047 0.328-0.141 0.469l-3.563 6.469c-0.328 0.609-0.984 1.031-1.734 1.031h-7.453l-0.891 1.641-0.047 0.141c0 0.141 0.094 0.234 0.234 0.234h11.578v2.016h-12c-1.078 0-1.969-0.938-1.969-2.016 0-0.328 0.094-0.656 0.234-0.938l1.359-2.484-3.609-7.594h-2.016v-1.969zM6.984 18c1.078 0 2.016 0.938 2.016 2.016s-0.938 1.969-2.016 1.969-1.969-0.891-1.969-1.969 0.891-2.016 1.969-2.016z"></path>
      </svg>);

      case ('local_hospital'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_laundry_service'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_library'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_mall'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('theaters'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_offer'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_parking'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_pharmacy'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_pizza'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('print'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_shipping'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('local_taxi'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('location_city'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('location_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('room'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('lock_open'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('lock_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('looks'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('looks_3'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('looks_4'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('looks_5'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('looks_6'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('looks_one'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('looks_two'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sync'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('loupe'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('low_priority'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('loyalty'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mail_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('map'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('markunread_mailbox'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('memory'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('menu'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3 6h18v2.016h-18v-2.016zM3 12.984v-1.969h18v1.969h-18zM3 18v-2.016h18v2.016h-18z"></path>
      </svg>);

      case ('message'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mic'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mic_none'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mic_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mms'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mode_comment'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('monetization_on'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('money_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('monochrome_photos'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mood_bad'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 14.016c2.344 0 4.313 1.406 5.109 3.469h-10.219c0.797-2.063 2.766-3.469 5.109-3.469zM8.484 11.016c-0.844 0-1.5-0.656-1.5-1.5s0.656-1.5 1.5-1.5 1.5 0.656 1.5 1.5-0.656 1.5-1.5 1.5zM15.516 11.016c-0.844 0-1.5-0.656-1.5-1.5s0.656-1.5 1.5-1.5 1.5 0.656 1.5 1.5-0.656 1.5-1.5 1.5zM12 20.016c4.406 0 8.016-3.609 8.016-8.016s-3.609-8.016-8.016-8.016-8.016 3.609-8.016 8.016 3.609 8.016 8.016 8.016zM12 2.016c5.531 0 9.984 4.453 9.984 9.984s-4.453 9.984-9.984 9.984-9.984-4.453-9.984-9.984 4.453-9.984 9.984-9.984z"></path>
      </svg>);

      case ('more'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('more_horiz'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 9.984c1.078 0 2.016 0.938 2.016 2.016s-0.938 2.016-2.016 2.016-2.016-0.938-2.016-2.016 0.938-2.016 2.016-2.016zM18 9.984c1.078 0 2.016 0.938 2.016 2.016s-0.938 2.016-2.016 2.016-2.016-0.938-2.016-2.016 0.938-2.016 2.016-2.016zM6 9.984c1.078 0 2.016 0.938 2.016 2.016s-0.938 2.016-2.016 2.016-2.016-0.938-2.016-2.016 0.938-2.016 2.016-2.016z"></path>
      </svg>);

      case ('more_vert'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 15.984c1.078 0 2.016 0.938 2.016 2.016s-0.938 2.016-2.016 2.016-2.016-0.938-2.016-2.016 0.938-2.016 2.016-2.016zM12 9.984c1.078 0 2.016 0.938 2.016 2.016s-0.938 2.016-2.016 2.016-2.016-0.938-2.016-2.016 0.938-2.016 2.016-2.016zM12 8.016c-1.078 0-2.016-0.938-2.016-2.016s0.938-2.016 2.016-2.016 2.016 0.938 2.016 2.016-0.938 2.016-2.016 2.016z"></path>
      </svg>);

      case ('motorcycle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('mouse'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('move_to_inbox'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('movie_creation'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('movie_filter'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('multiline_chart'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('music_note'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('music_video'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('nature'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('nature_people'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('navigation'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 2.016l7.5 18.281-0.703 0.703-6.797-3-6.797 3-0.703-0.703z"></path>
      </svg>);

      case ('near_me'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21 3l-7.547 18h-0.984l-2.625-6.844-6.844-2.625v-0.984z"></path>
      </svg>);

      case ('network_cell'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21.984 21.984h-19.969l19.969-19.969v19.969z"></path>
      </svg>);

      case ('network_check'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('network_locked'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('network_wifi'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('new_releases'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('next_week'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('nfc'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('no_encryption'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('signal_cellular_no_sim'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('note'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('note_add'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('notifications'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('notifications_active'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('notifications_none'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('notifications_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('notifications_paused'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('offline_pin'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('ondemand_video'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('opacity'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('open_in_browser'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('open_with'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pages'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pageview'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pan_tool'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('panorama'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('radio_button_unchecked'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('panorama_horizontal'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('panorama_vertical'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('panorama_wide_angle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('party_mode'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pause'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M14.016 5.016h3.984v13.969h-3.984v-13.969zM6 18.984v-13.969h3.984v13.969h-3.984z"></path>
      </svg>);

      case ('pause_circle_filled'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pause_circle_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('people_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('perm_camera_mic'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('perm_contact_calendar'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('perm_data_setting'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('perm_device_information'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('person_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('perm_media'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('perm_phone_msg'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('perm_scan_wifi'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('person'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 14.016c2.672 0 8.016 1.313 8.016 3.984v2.016h-16.031v-2.016c0-2.672 5.344-3.984 8.016-3.984zM12 12c-2.203 0-3.984-1.781-3.984-3.984s1.781-4.031 3.984-4.031 3.984 1.828 3.984 4.031-1.781 3.984-3.984 3.984z"></path>
      </svg>);

      case ('person_add'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('person_pin'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('person_pin_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('personal_video'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pets'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone_android'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone_bluetooth_speaker'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone_forwarded'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M20.016 15.516c0.563 0 0.984 0.422 0.984 0.984v3.516c0 0.563-0.422 0.984-0.984 0.984-9.375 0-17.016-7.641-17.016-17.016 0-0.563 0.422-0.984 0.984-0.984h3.516c0.563 0 0.984 0.422 0.984 0.984 0 1.266 0.188 2.438 0.563 3.563 0.094 0.328 0.047 0.75-0.234 1.031l-2.203 2.203c1.453 2.859 3.797 5.156 6.609 6.609l2.203-2.203c0.281-0.281 0.703-0.328 1.031-0.234 1.125 0.375 2.297 0.563 3.563 0.563zM18 11.016v-3h-3.984v-4.031h3.984v-3l5.016 5.016z"></path>
      </svg>);

      case ('phone_in_talk'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone_iphone'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone_locked'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone_missed'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phone_paused'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phonelink_erase'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phonelink_lock'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phonelink_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phonelink_ring'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('phonelink_setup'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo_album'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo_filter'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo_size_select_actual'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo_size_select_large'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('photo_size_select_small'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('picture_as_pdf'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('picture_in_picture'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('picture_in_picture_alt'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pie_chart'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pie_chart_outlined'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pin_drop'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('play_arrow'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M8.016 5.016l10.969 6.984-10.969 6.984v-13.969z"></path>
      </svg>);

      case ('play_circle_filled'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('play_circle_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('play_for_work'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('playlist_add'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('playlist_add_check'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('playlist_play'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M17.016 12.984l4.969 3-4.969 3v-6zM2.016 15v-2.016h12.984v2.016h-12.984zM18.984 5.016v1.969h-16.969v-1.969h16.969zM18.984 9v2.016h-16.969v-2.016h16.969z"></path>
      </svg>);

      case ('plus_one'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('polymer'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pool'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('portable_wifi_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('portrait'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('power'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('power_input'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('power_settings_new'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('pregnant_woman'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('present_to_all'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('priority_high'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('public'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('publish'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M5.016 14.016l6.984-7.031 6.984 7.031h-3.984v6h-6v-6h-3.984zM5.016 3.984h13.969v2.016h-13.969v-2.016z"></path>
      </svg>);

      case ('queue_music'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('queue_play_next'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('radio'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('radio_button_checked'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rate_review'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('receipt'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('recent_actors'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('record_voice_over'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('redo'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('refresh'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('remove'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18.984 12.984h-13.969v-1.969h13.969v1.969z"></path>
      </svg>);

      case ('remove_circle_outline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('remove_from_queue'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('visibility'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 9c1.641 0 3 1.359 3 3s-1.359 3-3 3-3-1.359-3-3 1.359-3 3-3zM12 17.016c2.766 0 5.016-2.25 5.016-5.016s-2.25-5.016-5.016-5.016-5.016 2.25-5.016 5.016 2.25 5.016 5.016 5.016zM12 4.5c5.016 0 9.281 3.094 11.016 7.5-1.734 4.406-6 7.5-11.016 7.5s-9.281-3.094-11.016-7.5c1.734-4.406 6-7.5 11.016-7.5z"></path>
      </svg>);

      case ('remove_shopping_cart'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('reorder'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('repeat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M17.016 17.016v-4.031h1.969v6h-12v3l-3.984-3.984 3.984-3.984v3h10.031zM6.984 6.984v4.031h-1.969v-6h12v-3l3.984 3.984-3.984 3.984v-3h-10.031z"></path>
      </svg>);

      case ('repeat_one'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('replay'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('replay_10'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('replay_30'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('replay_5'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('reply'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('reply_all'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('report'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('warning'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('restaurant'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('restore_page'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('ring_volume'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('room_service'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rotate_90_degrees_ccw'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rotate_left'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rotate_right'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rounded_corner'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('router'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rowing'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rss_feed'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('rv_hookup'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('satellite'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('save'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('scanner'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('school'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('screen_lock_landscape'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('screen_lock_portrait'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('screen_lock_rotation'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('screen_rotation'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('screen_share'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sd_storage'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('search'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9.516 14.016c2.484 0 4.5-2.016 4.5-4.5s-2.016-4.5-4.5-4.5-4.5 2.016-4.5 4.5 2.016 4.5 4.5 4.5zM15.516 14.016l4.969 4.969-1.5 1.5-4.969-4.969v-0.797l-0.281-0.281c-1.125 0.984-2.625 1.547-4.219 1.547-3.609 0-6.516-2.859-6.516-6.469s2.906-6.516 6.516-6.516 6.469 2.906 6.469 6.516c0 1.594-0.563 3.094-1.547 4.219l0.281 0.281h0.797z"></path>
      </svg>);

      case ('security'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('select_all'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('send'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M2.016 21v-6.984l15-2.016-15-2.016v-6.984l21 9z"></path>
      </svg>);

      case ('sentiment_dissatisfied'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sentiment_neutral'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sentiment_satisfied'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sentiment_very_dissatisfied'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sentiment_very_satisfied'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_applications'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_backup_restore'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_bluetooth'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_brightness'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_cell'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_ethernet'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_input_antenna'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_input_composite'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_input_hdmi'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_input_svideo'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_overscan'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_phone'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_power'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_remote'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_system_daydream'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('settings_voice'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('share'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18 16.078c1.594 0 2.906 1.313 2.906 2.906s-1.313 2.953-2.906 2.953-2.906-1.359-2.906-2.953c0-0.234 0-0.469 0.047-0.656l-7.078-4.125c-0.563 0.516-1.266 0.797-2.063 0.797-1.641 0-3-1.359-3-3s1.359-3 3-3c0.797 0 1.5 0.281 2.063 0.797l7.031-4.078c-0.047-0.234-0.094-0.469-0.094-0.703 0-1.641 1.359-3 3-3s3 1.359 3 3-1.359 3-3 3c-0.797 0-1.5-0.328-2.063-0.844l-7.031 4.125c0.047 0.234 0.094 0.469 0.094 0.703s-0.047 0.469-0.094 0.703l7.125 4.125c0.516-0.469 1.219-0.75 1.969-0.75z"></path>
      </svg>);

      case ('shop'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('shop_two'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('shopping_basket'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('short_text'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3.984 12.984h10.031v2.016h-10.031v-2.016zM3.984 9h16.031v2.016h-16.031v-2.016z"></path>
      </svg>);

      case ('show_chart'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3.516 18.469l-1.5-1.5 7.5-7.5 3.984 4.031 7.078-7.969 1.406 1.406-8.484 9.563-3.984-4.031z"></path>
      </svg>);

      case ('shuffle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('signal_cellular_4_bar'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M2.016 21.984l19.969-19.969v19.969h-19.969z"></path>
      </svg>);

      case ('signal_cellular_connected_no_internet_4_bar'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('signal_cellular_null'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21.984 2.016v19.969h-19.969zM20.016 6.844l-13.172 13.172h13.172v-13.172z"></path>
      </svg>);

      case ('signal_cellular_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('signal_wifi_4_bar'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 21.469l-11.625-14.484c0.469-0.328 4.922-3.984 11.625-3.984s11.156 3.656 11.625 3.984z"></path>
      </svg>);

      case ('signal_wifi_4_bar_lock'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('signal_wifi_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sim_card'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sim_card_alert'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('skip_next'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.984 6h2.016v12h-2.016v-12zM6 18v-12l8.484 6z"></path>
      </svg>);

      case ('skip_previous'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9.516 12l8.484-6v12zM6 6h2.016v12h-2.016v-12z"></path>
      </svg>);

      case ('slideshow'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('slow_motion_video'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('stay_primary_portrait'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('smoke_free'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('smoking_rooms'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('textsms'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('snooze'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sort'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3 12.984v-1.969h12v1.969h-12zM3 6h18v2.016h-18v-2.016zM3 18v-2.016h6v2.016h-6z"></path>
      </svg>);

      case ('sort_by_alpha'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('spa'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('space_bar'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18 9h2.016v6h-16.031v-6h2.016v3.984h12v-3.984z"></path>
      </svg>);

      case ('speaker'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('speaker_group'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('speaker_notes'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('speaker_notes_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('speaker_phone'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('spellcheck'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('star_border'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 15.422l3.75 2.25-0.984-4.266 3.328-2.906-4.406-0.375-1.688-4.031-1.688 4.031-4.406 0.375 3.328 2.906-0.984 4.266zM21.984 9.234l-5.438 4.734 1.641 7.031-6.188-3.75-6.188 3.75 1.641-7.031-5.438-4.734 7.172-0.609 2.813-6.609 2.813 6.609z"></path>
      </svg>);

      case ('star_half'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M12 15.422l3.75 2.25-0.984-4.266 3.328-2.906-4.406-0.375-1.688-4.031v9.328zM21.984 9.234l-5.438 4.734 1.641 7.031-6.188-3.75-6.188 3.75 1.641-7.031-5.438-4.734 7.172-0.609 2.813-6.609 2.813 6.609z"></path>
      </svg>);

      case ('stars'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('stay_primary_landscape'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('stop'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6 6h12v12h-12v-12z"></path>
      </svg>);

      case ('stop_screen_share'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('storage'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('store_mall_directory'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('straighten'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('streetview'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('strikethrough_s'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('style'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('subdirectory_arrow_left'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M11.016 9l1.406 1.406-3.609 3.609h9.188v-10.031h2.016v12h-11.203l3.609 3.609-1.406 1.406-6-6z"></path>
      </svg>);

      case ('subdirectory_arrow_right'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M18.984 15l-6 6-1.406-1.406 3.609-3.609h-11.203v-12h2.016v10.031h9.188l-3.609-3.609 1.406-1.406z"></path>
      </svg>);

      case ('subject'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('subscriptions'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('subtitles'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('subway'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('supervisor_account'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('surround_sound'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('swap_calls'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('swap_horiz'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21 9l-3.984 3.984v-3h-7.031v-1.969h7.031v-3zM6.984 11.016v3h7.031v1.969h-7.031v3l-3.984-3.984z"></path>
      </svg>);

      case ('swap_vert'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M9 3l3.984 3.984h-3v7.031h-1.969v-7.031h-3zM15.984 17.016h3l-3.984 3.984-3.984-3.984h3v-7.031h1.969v7.031z"></path>
      </svg>);

      case ('swap_vertical_circle'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('switch_camera'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('switch_video'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sync_disabled'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('sync_problem'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('system_update'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('system_update_alt'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tab'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tab_unselected'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tablet'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tablet_android'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tablet_mac'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tap_and_play'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('text_fields'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21.516 9v3h-3v6.984h-3v-6.984h-3v-3h9zM2.484 3.984h13.031v3h-5.016v12h-3v-12h-5.016v-3z"></path>
      </svg>);

      case ('text_format'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('texture'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('thumb_down'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('thumb_up'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('thumbs_up_down'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('timelapse'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('timeline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('timer'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('timer_10'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('timer_3'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('timer_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('title'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M5.016 3.984h13.969v3h-5.484v12h-3v-12h-5.484v-3z"></path>
      </svg>);

      case ('toc'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('today'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('toll'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tonality'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('touch_app'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('toys'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('track_changes'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('traffic'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('train'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tram'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('transfer_within_a_station'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('transform'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('translate'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.891 17.016h3.234l-1.641-4.359zM18.516 9.984l4.5 12h-2.016l-1.125-3h-4.734l-1.125 3h-2.016l4.5-12h2.016zM12.891 15.047l-0.797 2.063-3.094-3.094-5.016 4.969-1.406-1.406 5.109-5.016c-1.266-1.406-2.25-2.906-3-4.547h2.016c0.609 1.172 1.359 2.297 2.297 3.328 1.453-1.594 2.531-3.422 3.188-5.344h-11.203v-2.016h7.031v-1.969h1.969v1.969h7.031v2.016h-2.953c-0.75 2.344-1.969 4.594-3.703 6.516l-0.047 0.047z"></path>
      </svg>);

      case ('trending_down'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('trending_flat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21.984 12l-3.984 3.984v-3h-15v-1.969h15v-3z"></path>
      </svg>);

      case ('trending_up'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M15.984 6h6v6l-2.297-2.297-6.281 6.281-3.984-3.984-6 6-1.406-1.406 7.406-7.406 3.984 3.984 4.875-4.875z"></path>
      </svg>);

      case ('tune'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('tv'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('unarchive'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('undo'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('unfold_less'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('unfold_more'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('update'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('usb'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('verified_user'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('vertical_align_bottom'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3.984 18.984h16.031v2.016h-16.031v-2.016zM15.984 12.984l-3.984 4.031-3.984-4.031h3v-9.984h1.969v9.984h3z"></path>
      </svg>);

      case ('vertical_align_center'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('vertical_align_top'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3.984 3h16.031v2.016h-16.031v-2.016zM8.016 11.016l3.984-4.031 3.984 4.031h-3v9.984h-1.969v-9.984h-3z"></path>
      </svg>);

      case ('vibration'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('video_call'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('video_label'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('video_library'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('videocam'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('videocam_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('videogame_asset'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_agenda'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_array'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M8.016 18v-12.984h9v12.984h-9zM18 5.016h3v12.984h-3v-12.984zM3.984 18v-12.984h3v12.984h-3z"></path>
      </svg>);

      case ('view_carousel'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_column'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_comfy'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_compact'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3 5.016h18.984v6h-18.984v-6zM9.984 18.984v-6.984h12v6.984h-12zM3 18.984v-6.984h6v6.984h-6z"></path>
      </svg>);

      case ('view_day'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_headline'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_list'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_module'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_quilt'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('view_stream'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M3.984 5.016h17.016v6h-17.016v-6zM3.984 18v-6h17.016v6h-17.016z"></path>
      </svg>);

      case ('view_week'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('vignette'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('visibility_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('voice_chat'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('voicemail'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('volume_down'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('volume_mute'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M6.984 9h4.031l4.969-5.016v16.031l-4.969-5.016h-4.031v-6z"></path>
      </svg>);

      case ('volume_off'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('volume_up'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('vpn_key'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('vpn_lock'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wallpaper'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('watch'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('watch_later'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wb_auto'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wb_incandescent'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wb_iridescent'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wb_sunny'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wc'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('web'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('web_asset'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('weekend'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('whatshot'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('widgets'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wifi'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wifi_lock'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wifi_tethering'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('work'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('wrap_text'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('youtube_searched_for'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('zoom_in'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('zoom_out'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('zoom_out_map'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
      ...
      case ('optimised'): return (<svg height={height || size} width={width || size} onClick={onClick} fill={color} >
        <path d="M21 15v6h-6l2.297-2.297-2.906-2.859 1.453-1.453 2.859 2.906zM9 21h-6v-6l2.297 2.297 2.859-2.906 1.453 1.453-2.906 2.859zM3 9v-6h6l-2.297 2.297 2.906 2.859-1.453 1.453-2.859-2.906zM15 3h6v6l-2.297-2.297-2.859 2.906-1.453-1.453 2.906-2.859z"></path>
      </svg>);
      };
    // tslint:enable
